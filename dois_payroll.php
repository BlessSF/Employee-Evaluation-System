...
<?php 
    ...
    if (isset($_GET['search']) && !empty($_GET['search'])) {
        ...
        // SQL query to fetch DOIS employees and their payroll data
    ...
    p.others, p.cp, p.cash_advance, p.total_deductions, p.adjustment, p.net_pay
                ...
                AND e.branch = 'DOIS'";  // Updated to filter by DOIS branch
    ...
    p.others, p.cp,p.cash_advance, p.total_deductions, p.adjustment, p.net_pay
                ...
                FROM employees e
                LEFT JOIN dois_payroll p ON e.id = p.employee_id
                WHERE e.branch = 'DOIS'";  // Updated to filter by DOIS branch
...
<body>
    ...
    <div class="main">
        <header>
            <h1>DOIS Payroll Data</h1>  <!-- Updated header -->
        </header>
